...
class TextReplacerTest extends TestCase
{
    ...
    public function testReplaceFromContentCase2()
    {
        ...
        $this->assertStringContainsString('<p>paragraph1 <span>span</span> paragraph2 <i>italic</i> paragraph3 <b>bold</b></p>', $content, 'It should container "paragraph1"');
        $this->assertStringContainsString('<div>div1 <div>div2</div>div3</div>', $content, 'It should container "div1"');
        ...
        $this->assertStringContainsString('brizy-wp-pricing-1.jpg ', $content, 'It should contain "brizy-wp-pricing-1.jpg"');
        $this->assertStringContainsString('brizy-wp-pricing-2.jpg ', $content, 'It should contain "brizy-wp-pricing-2.jpg"');
        $this->assertStringContainsString('brizy-wp-pricing-11.jpg ', $content, 'It should contain "brizy-wp-pricing-11.jpg"');
        $this->assertStringContainsString('brizy-wp-pricing-22.jpg ', $content, 'It should contain "brizy-wp-pricing-22.jpg"');
        $this->assertStringContainsString('brizy-wp-pricing-13.jpg"', $content, 'It should contain "brizy-wp-pricing-13.jpg"');
        $this->assertStringContainsString('brizy.jpg"', $content, 'It should contain "brizy.jpg"');
        $this->assertStringContainsString('NOT INCLUDE STYLE FROM HEAD<', $content, 'It should contain "NOT INCLUDE STYLE FROM HEAD"');
        $this->assertStringContainsString('NOT INCLUDE SCRIPT FROM HEAD<', $content, 'It should contain "NOT INCLUDE SCRIPT FROM HEAD"');
        $this->assertStringContainsString('NOT INCLUDE STYLE FROM HEAD<', $content, 'It should contain "NOT INCLUDE STYLE FROM BODY"');
        $this->assertStringContainsString('NOT INCLUDE SCRIPT FROM HEAD<', $content, 'It should contain "NOT INCLUDE SCRIPT FROM BODY"');
    }
}
